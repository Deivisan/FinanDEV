...
> **Objetivo:** Maximizar hardware câmera (48MP principal, 8MP ultra-wide, 2MP macro)  
> **Criado:** 16/11/2025  
> **Status:** Em testes - coletando dados reais de cada GCam port  
...
| Feature | Status | Notas |
|---------|--------|-------|
| HDR+ Interiores | ⚪ | Ótimo para setup dev |
| Night Sight | ⚪ | - |
| Panorama 360° | ⚪ | - |
| Filmagem 4K 60fps | ⚪ | - |
| Sensor Ultra-Wide | ⚪ | - |
...
### Fontes GCam Ports
- **Celso Azevedo:** celsoazevedo.com/files/android/google-camera
  - Dev BSG: MGC 9.4, 9.6 betas
  - Dev Hasli: LMC 8.4
