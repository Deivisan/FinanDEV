...
> **Objetivo:** Visualizar métricas vida real-time + ações rápidas  
> **Stack:** HTML/CSS/JS (frontend) + Python API (backend) + Git automation  
> **Status:** 🚧 Em construção - orquestração inicial  
> **Criado:** 16/11/2025
...
- **Features:**
  - Cards interativos (peso, finanças, sono)
  - Gráficos Chart.js (linha peso, barra calorias)
  - Timeline fotos progresso
  - Quick actions (botões ação rápida)

### Backend (dashboard.py - FastAPI)
- **Funções:**
  - Ler `Vida-Deivison.json` → parse métricas
  - Calcular médias semana (peso, sono, humor)
  - Git stats (commits semana, linhas adicionadas)
  - Scrape transcrições (última conversa Grok)
...
Dados:
  ...
  - Meta: 70kg (maio/2026)
  - Progresso: 0% (0/10kg)
  - Última foto: [A ADICIONAR]
  - Próxima foto: 01/12/2025
Ações:
  - [Registrar peso]
  - [Upload foto]
  - [Ver timeline]
...
Dados:
  - Calorias: 2400 kcal/dia
  - Proteínas: 100g/dia
  - Refeições: 5/dia
  - Água: [A TRACKEAR] 2L meta
Gráfico:
  - Semana: barras calorias/proteínas
Ações:
  - [Registrar refeição]
  - [Ver cardápio semana]
```
...
Título: "Finanças 💰"
Dados:
  - Salário líquido: R$ 1.866,53
  - Gastos fixos: R$ 780,00
...
Título: "Sono & Humor 😴"
Dados:
  - Horas sono ontem: [AUTO-INFERIR timestamps]
  - Qualidade: [0-10 escala]
  - Humor hoje: [1-5 escala]
  - Gatilhos: [lista recente]
Gráfico:
  - Linha: horas sono última semana
Ações:
  - [Registrar humor]
  - [Adicionar gatilho]
```
...
Título: "Pendências ⚠️"
Lista:
  - [ ] Testar 5 GCam ports Poco X5
  - [ ] Capturar 20-30 fotos rosto
  - [ ] Implementar email-cleanup.py
  - [ ] Preencher Ambiente-Dev/PC/
  - [ ] Organizar Google Photos álbuns
Ações:
  - [Adicionar tarefa]
  - [Marcar completa]
```
...
Dados:
  - Commits: 4
  - Linhas adicionadas: 4538
  - Arquivos alterados: 10
  - Última mensagem: "feat: ambiente-dev completo..."
Gráfico:
  - Heatmap: commits por dia
Ações:
  - [Commit rápido]
  - [Ver roadmap]
```
...
Fotos:
  - [VAZIO] - Aguardando primeira captura
Metadata cada foto:
  - Data: DD/MM/YYYY
  - Peso: XXkg
